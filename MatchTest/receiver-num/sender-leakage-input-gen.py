...
def main():
    ...
    allZeroObjects = int((totalObjects - usernum * uniqueness) / (otN ** usernum))
    #print("allZeroObjects: ", allZeroObjects)
    totalLeakableObjects = int(totalObjects - usernum * uniqueness)
    #print("totalLeakableObjects: ", totalReceivedObjects)
    totalLeakedObjects = int(totalLeakableObjects * rate)
    #print("total leaked Objects: ", totalLeakedObjects)
    prob = 1 - ((totalLeakableObjects - allZeroObjects)/totalLeakableObjects) ** totalLeakedObjects
