function sender_leakage_ot_result(name1)
...
my_yticks = [1e-14 1e-12 1e-10 1e-8 1e-6 1e-4 0.1 0.5 1 5 20];
my_ylabels = {'<10^{-14}','10^{-12}','10^{-10}','10^{-8}','10^{-6}','10^{-4}','0.1','0.5','1','5','20'};
